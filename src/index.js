...
$(document).ready(() => {
    ...
    socket.on('message', data => {
        ...
        if (newAuthor) {
            messageContent = '<div class="message message-' + contentType + '"><p class="message-author flex align-center"><i class="' + data.user.avatar + '"></i>' + data.user.pseudo + '</p><div class="flex flex-horizontal flex-center"><p class="message-content">' + data.content + '</p><p class="message-date">' + moment().format('HH:mm:ss'); + '<p/></div></div>'
        } else {
